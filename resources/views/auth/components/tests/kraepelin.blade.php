    ...
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input value="{{ date('j M Y', strtotime($test_identities->date)) }}" type="text" required="required" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input value="{{ date('Y', strtotime($test_identities->date)) - date('Y', strtotime($user->birthday))." Tahun" }}" type="text" required="required" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="item form-group">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input value="{{ $test_identities->num_test }}" type="text" required="required" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="item form-group">
                ...
                <form class="col-md-12" method="POST" action="{{ route('auth.test.store.to.database') }}">
                    @csrf
                    @php
                        $num = 0;
                    @endphp    
