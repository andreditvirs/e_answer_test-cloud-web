    ...
    <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
              <form method="POST" action="{{ route('auth.inputResultTest.disc.store') }}">
                @csrf
                                ...
                                <div class="col">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-10 col-sm-10 ">
                                            <div class="row">
                                                <div class="col">
                                                    <input name="{{ 'S-'.($num + $i) }}" value="" type="number" class="form-control" placeholder="S">
                                                </div>
                                                <div class="col">
                                                    <input name="{{ 'T-'.($num + $i) }}" value="" type="number" class="form-control" placeholder="T">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-10 col-sm-10 ">
                                            <div class="row">
                                                <div class="col">
                                                    <input name="{{ 'M-'.($num + $i) }}" value="" type="number" class="form-control" placeholder="M">
                                                </div>
                                                <div class="col">
                                                    <input name="{{ 'L-'.($num + $i) }}" value="" type="number" class="form-control" placeholder="L">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
