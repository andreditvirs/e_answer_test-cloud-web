                    ...
                    <div class="row">
                        @for ($i = 1; $i <= 5; $i++)
                            @if($num + $i > 38)
                                ...
                                <div class="col">
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-2 col-sm-2 label-align text-left">{{ $num + $i }} <span class="required text-danger"></span>
                                        </label>
                                        <div class="col-md-10 col-sm-10 ">
                                            <div class="row">
                                                <div class="col">
                                                    <input name="{{ 'S-'.($num + $i) }}" value="{{ $answer["S-".($num + $i)] }}" type="number" class="form-control" placeholder="S" readonly>
                                                </div>
                                                <div class="col">
                                                    <input name="{{ 'T-'.($num + $i) }}" value="{{ $answer["T-".($num + $i)] }}" type="number" class="form-control" placeholder="T" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-10 col-sm-10 ">
                                            <div class="row">
                                                <div class="col">
                                                    <input name="{{ 'M-'.($num + $i) }}" value="{{ $answer["M-".($num + $i)] }}" type="number" class="form-control" placeholder="M" readonly>
                                                </div>
                                                <div class="col">
                                                    <input name="{{ 'L-'.($num + $i) }}" value="{{ $answer["L-".($num + $i)] }}" type="number" class="form-control" placeholder="L" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
