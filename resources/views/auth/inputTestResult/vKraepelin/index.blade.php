...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3> Data <small> input hasil tes V-Kraepelin</small> </h3>
      </div>
        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="btn btn-success text-dark" href="{{ route('auth.inputResultTest.vKraepelin.create') }}">Buat Data Baru</a></li>
            </ul>
            <div class="clearfix"></div>
                      ...
                      <tbody>
                        @foreach ($results as $result)
                          <tr>
                            ...
                            <td>
                              <a target="_blank" class="btn btn-sm btn-secondary" href="{{ route('auth.inputResultTest.vKraepelin.show', ["id" => $result->id]) }}">Lihat</a>
                              <form name="deleteForm" action="{{ route('auth.inputResultTest.vKraepelin.delete') }}" method="POST" style="display: inline;">
                                @csrf
